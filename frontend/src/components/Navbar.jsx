  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        sticky
          ? "shadow-md bg-base-100 dark:bg-slate-900 dark:text-white"
      ...
      <div className="navbar">
        ...
        <div className="navbar-end space-x-3">
          ...
          <div className="hidden md:block">
            <form onSubmit={handleSearch}>
              <label className={`input input-bordered flex items-center gap-2 w-96 ${theme === "dark" ? "bg-slate-900 text-white" : ""}`}>
                <input
                  type="text"
                  className="grow"
                  placeholder="Search"
